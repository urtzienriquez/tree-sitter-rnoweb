...
enum ts_symbol_identifiers {
  ...
  sym_rchunk = 22,
  sym_rinline = 23,
  sym_renv_sig_options = 24,
  sym__renv_options = 25,
  sym__renv_engine = 26,
  sym_renv_engine_val = 27,
  sym_renv_key_pair = 28,
  sym_renv_val = 29,
  sym_latex = 30,
  aux_sym_source_file_repeat1 = 31,
  aux_sym__renv_options_repeat1 = 32,
  aux_sym_latex_repeat1 = 33,
  alias_sym_renv_label = 34,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [39] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rchunk, 3, 0, 0),
  ...
  [69] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__renv_options_repeat1, 2, 0, 0), SHIFT_REPEAT(14),
