...
enum ts_symbol_identifiers {
  ...
  anon_sym_RBRACE = 4,
  aux_sym_renv_sig_options_token1 = 5,
  anon_sym_COMMA = 6,
  anon_sym_engine = 7,
  anon_sym_EQ = 8,
  anon_sym_DQUOTE = 9,
  anon_sym_SQUOTE = 10,
  aux_sym_renv_key_pair_token1 = 11,
  sym_renv_engine_key = 12,
  sym_renv_key = 13,
  aux_sym_renv_val_token1 = 14,
  aux_sym_renv_val_token2 = 15,
  aux_sym_renv_val_token3 = 16,
  sym__latex_word = 17,
  sym_command_name = 18,
  sym__renv_sig_beg = 19,
  sym__renv_sig_end = 20,
  sym_renv_content = 21,
  sym_source_file = 22,
  sym_rchunk = 23,
  sym_rinline = 24,
  sym_renv_sig_options = 25,
  sym__renv_options = 26,
  sym__renv_engine = 27,
  sym_renv_engine_val = 28,
  sym_renv_key_pair = 29,
  sym_renv_val = 30,
  sym_latex = 31,
  aux_sym_source_file_repeat1 = 32,
  aux_sym__renv_options_repeat1 = 33,
  aux_sym_latex_repeat1 = 34,
  alias_sym_renv_label = 35,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [anon_sym_RBRACE] = "}",
  [aux_sym_renv_sig_options_token1] = "renv_sig_options_token1",
  [anon_sym_COMMA] = ",",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [aux_sym_renv_sig_options_token1] = aux_sym_renv_sig_options_token1,
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [aux_sym_renv_sig_options_token1] = {
    .visible = false,
    .named = false,
  },
  [anon_sym_COMMA] = {
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 13:
      ...
      END_STATE();
    case 14:
      ACCEPT_TOKEN(aux_sym_renv_sig_options_token1);
      if (lookahead == ' ') ADVANCE(14);
      if (lookahead == ',') ADVANCE(15);
      END_STATE();
    case 15:
